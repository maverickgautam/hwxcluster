...
public class EmbeddedSolrServerUnit {

    /**
     * Cleans the given solrHome directory and creates a new EmbeddedSolrServerUnit.
     *
     ...
     * @return an EmbeddedSolrServerUnit with a core created for the given coreName
     * @throws IOException
     */
    ...
    public static SolrClient create(final String solrHome, final String configSetHome, final String coreName, final boolean cleanSolrHome)
        ...
        final org.apache.solr.client.solrj.embedded.EmbeddedSolrServer embeddedSolrServer = new org.apache.solr.client.solrj.embedded.EmbeddedSolrServer(config, coreName);
