...
public class SparkServer2Client {
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:hive2://cluster20186.field.hortonworks.com:10016/default;httpPath=/;principal=hive/cluster20186.field.hortonworks.com@FIELD.HORTONWORKS.COM");
